        ...
        <main>
            ...
            <c:if test="${numeroPaginas==null}">
                <div>
                    ...
                    <a class="btn btn-outline-info" role="button" aria-pressed="true" href="/proyectoSedesol/ControladorProcesos?proceso=listado&estado=${estado}">Volver al listado completo</a>
                </div>
            </c:if>
            <div> 
                <c:if test="${numeroPaginas!=null}"> 
                ...
                <nav class="navbar buscador">
                    <div style="margin-right: 30rem;">
                        ...
                        <form action="/proyectoSedesol/CrearExcel" method="GET">
                    ...
                    <form action="/proyectoSedesol/ControladorProcesos" method="GET" class="form-inline">
