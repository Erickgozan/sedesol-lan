    ...
    <main>
        ...
        <div>
            <c:if test="${estado=='OFICINAS CENTRALES'}"> 
                ...
                <a class="btn btn-outline-info" role="button" aria-pressed="true" href="/proyectoSedesol/ControladorCR?proceso=listarCR&estado=${estado}">Volver al listado completo</a>
            </c:if>
        </div>
        <div> 
            <nav class="navbar buscador">
                <div style="margin-right: 120px">
                    ...
                    <form action="/proyectoSedesol/CrearExcelCr" method="GET">
                ...
                <c:if test="${estado!='OFICINAS CENTRALES'}"> 
                    <div style="padding-right: 100px">
                        <!--Enlace para volver al listado completo-->
                        <a class="btn btn-outline-info" role="button" aria-pressed="true" href="/proyectoSedesol/ControladorCD?proceso=listarCD&estado=${estado}">Volver al listado completo</a>
                    </div>   
                </c:if>


                <form action="/proyectoSedesol/ControladorCR" method="GET" class="form-inline">
                    <c:if test="${estado=='OFICINAS CENTRALES'}">
