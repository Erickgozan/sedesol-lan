        ...
        <c:if test="${privilegio=='Estandar' || privilegio=='Administrador' }">
            ...
            <main>
                <article>
                    ...
                    <!--BUSCAR LA ESTANCIA-->
                    <form action="/proyectoSedesol/ControladorCD" method="GET" id="formbuscar">
                    ...
                    <c:if test="${datosEstancia.id_estancia!=null}">
                        <form action="proyectoSedesol/../ControladorCD" method="POST"  id="formsubirDatosCD" enctype="multipart/form-data" >     
