        ...
        try {
            ...
            for (Object input : items) {
                ...
                if (!archivosSubidos.isFormField()) {
                    rutaCompleta = rutaCarpta + "/" + archivosSubidos.getName();
                    ...
                    for (int i = 0; i < ficheros.length; i++) {
                        ...
                        if (i == 0) {
                            estancia.setRuta_docD1(rutaArchivos.get(0));
                        } else if (i == 1) {
                            estancia.setRuta_docD2(rutaArchivos.get(1));
                        } else if (i == 2) {
                            estancia.setRuta_docD3(rutaArchivos.get(2));
                        } else if (i == 3) {
                            estancia.setRuta_docD4(rutaArchivos.get(3));
                        } else if (i == 4) {
                            estancia.setRuta_docD5(rutaArchivos.get(4));
                        } else if (i == 5) {
                            estancia.setRuta_docD6(rutaArchivos.get(5));
                        } else if (i > 5) {
