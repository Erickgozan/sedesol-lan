$(document).ready(function () {
        ...
        if (txtFechaInicio !== "") {
            if (archivo.length === 1) {
                ...
                if (ext === 'pdf') {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/proyectoSedesol/ControladorProcesos",
                        data: dataForm,
                        contentType: false,
                        processData: false,
        ...
        if (txtCambioDireccion !== '') {
            if (archivo.length === 1) {
                ...
                if (ext === 'pdf') {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/proyectoSedesol/ControladorCD",
                        data: dataForm,
                        contentType: false,
                        processData: false,
                        success: function (dataForm) {
        ...
        if (txtResponsable !== '') {
            if (archivo.length === 1) {
                ...
                if (ext === 'pdf') {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/proyectoSedesol/ControladorCR",
                        data: dataForm,
                        contentType: false,
                        processData: false,
                        success: function (dataForm) {
    ...
    $("#btnEnviarRev").click(function (e) {
        ...
        if (selectNombreEstancia === '') {
            ...
            $.post("/proyectoSedesol/ControladorProcesos",
    ...
    $("#btnEnviarRevDomicilio").click(function (e) {
        ...
        if (selectDoc1 === '') {
            ...
            $.post("/proyectoSedesol/ControladorCD",
                    {//etiqueta name--------//etiqueta id
                        proceso: proceso,
    ...
    $("#btnEnviarRevResponsable").click(function (e) {
        ...
        if (selectDoc1 === '') {
            ...
            $.post("/proyectoSedesol/ControladorCR",
                    {//etiqueta name--------//etiqueta id
                        proceso: proceso,
                        selectDoc1: selectDoc1,
                        selectDoc2: selectDoc2,
    ...
    $("#agregarUsuario").click(function (e) {
        ...
        if (txtUsuario === '') {
            ...
            $.post("/proyectoSedesol/ControladorUsuario",
                    {//etiqueta name--------//etiqueta id
                        proceso:proceso,
    ...
    $("#salirUsuario").click(function (e){
            location.href="/proyectoSedesol/ControladorUsuario?proceso=listarUsuario";
    });
