    ...
    <body>
        <c:if test="${privilegio=='Procesos' || privilegio=='Administrador' }">
            ...
            <main>
                ...
                <article>
                    <form action="/proyectoSedesol/ControladorProcesos" method="GET">
                    ...
                    <c:if test="${DatosDoc.id_estancia!=null}">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>${DatosDoc.fecha_inicio}</td>
                                     <td><fmt:formatDate value="${DatosDoc.fehca_fin}" pattern="dd/MM/yyyy"/></td>               
                                </tr>
                        ...
                        <c:if test="${DatosDoc.ruta_doc!=null}">
                            <form action="/proyectoSedesol/ControladorProcesos" method="POST" id="formRevisarDoc">
                                ...
                                <div class="documento">
                                    <c:url var="linkTempDoc" value="/proyectoSedesol/../VisualizarPDF">
